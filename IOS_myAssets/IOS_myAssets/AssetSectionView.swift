...
struct AssetSectionView_Previews: PreviewProvider {
    static var previews: some View {
        let asset = Asset(id: 0, type: .bankAccount, data: [AssetData(id: 0, title: "신한은행", amount: "5,300,300원"),AssetData(id: 1, title: "국민은행", amount: "15,300,300원"),AssetData(id: 2, title: "카카오뱅크", amount: "25,300,000원")])
